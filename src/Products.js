            ...
            <div className="relative px-10 overflow-hidden text-white bg-black py-36 md:h-screen xl:pl-48 xl:pr-0">
                ...
                <div className="grid justify-center grid-cols-4 mt-10 md:gap-10 md:max-w-lg">
                    <div className="col-span-4 md:col-span-2">
                        ...
                        <img src={laminate1} className="absolute z-20 bottom-28 md:bottom-12 right-52 h-96 lg:h-full lg:-bottom-96 lam-image1 lg:right-48" alt="Acrylic Laminate" />
                        <img src={laminate2} className="absolute z-30 right-32 md:bottom-12 bottom-28 h-96 lg:h-full lg:-bottom-96 lam-image2 lg:right-24" alt="PVC Laminate" />
                    </div>
                    <div className="col-span-4 md:col-span-2 mb-96">
                        ...
                        <img src={laminate3} className="absolute z-40 h-96 lg:h-full md:bottom-12 bottom-28 right-10 lg:-bottom-96 lam-image3 lg:-right-4" alt="MDF Board" />
                        <img src={laminate4} className="absolute z-50 -right-10 h-96 md:bottom-12 bottom-28 lg:h-full lg:-bottom-96 lam-image4 lg:-right-32" alt="Decorative Laminate" />
                    </div>
                    <a href="#products-container"><p className="absolute flex items-center text-base font-normal bottom-10 md:bottom-20 hover:opacity-75">View All Products <BsArrowDown className="ml-4" size={30} /></p></a>
                </div>
            </div>
                        ...
                        return (
                            index === id ?
                                <div className="relative grid justify-center grid-cols-3 text-left bg-transparent lg:h-screen lg:overflow-hidden tab-content" key={id}>
                                    ...
                                    <div className="relative z-10 w-full col-span-3 p-10 bg-white md:py-20 lg:w-5/12 lg:absolute lg:h-screen lg:z-0 lg:right-10 rounded-18">
