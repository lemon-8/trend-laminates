    ...
    return (
        <div className="px-10 pt-20 md:pt-36 pb-28 xl:px-44">
            ...
            <div className="grid items-center grid-cols-6 gap-10 mt-20">
                <div className="col-span-6 overflow-hidden rounded-md md:col-span-3" data-aos="fade-right">
                    <img src={trend} alt="" className="h-full duration-500 transform rounded-md hover:scale-125" />
                </div>
                <div className="col-span-6 md:pr-20 md:col-span-3" data-aos="fade-left">
            ...
            <div className="flex flex-col-reverse items-center grid-cols-6 gap-10 my-20 md:grid">
                <div className="col-span-6 md:pr-24 md:col-span-3" data-aos="fade-right">
                ...
                <div className="col-span-6 overflow-hidden rounded-md md:col-span-3" data-aos="fade-left">
            ...
            <div className="relative z-10 text-center text-white" data-aos="fade-up">
                <div className="overflow-hidden rounded-md">
                    <img src={principle} alt="" className="w-full duration-500 transform rounded-md h-96 md:h-auto hover:scale-125" />
                </div>
                <div className="absolute transform md:-translate-y-1/2 md:-translate-x-1/2 top-10 left-10 right-10 md:top-1/2 md:left-1/2">
            ...
            <div className="grid items-center grid-cols-6 gap-10 mt-20">
                ...
                <div className="col-span-6 md:col-span-3" data-aos="fade-left">
