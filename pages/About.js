            ...
            <div className="px-10 pt-36 pb-28 xl:px-44">
                ...
                <div className="grid items-center grid-cols-6 gap-10 mt-20">
                    <div className="col-span-3 overflow-hidden rounded-md" data-aos="fade-right">
                        <img src="/left_compare.png" alt="" className="h-full duration-500 transform rounded-md hover:scale-125" />
                    </div>
                ...
                <div className="grid items-center grid-cols-6 gap-10 my-20">
                    ...
                    <div className="col-span-3 overflow-hidden rounded-md" data-aos="fade-left">
                        <img src="/mission.png" alt="" className="w-full duration-500 transform rounded-md hover:scale-125" />
                    </div>
                </div>

                <div className="relative z-10 text-center text-white" data-aos="fade-up">
                    <div className="overflow-hidden rounded-md">
                        <img src="/principle_bg.png" alt="" className="w-full duration-500 transform rounded-md hover:scale-125" />
                    </div>
                ...
                <div className="grid items-center grid-cols-6 gap-10 mt-20">
                    <div className="col-span-3 overflow-hidden rounded-md" data-aos="fade-right">
                        <img src="/decorative.png" alt="" className="duration-500 transform rounded-md hover:scale-125" />
                    </div>
