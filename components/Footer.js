        ...
        <div className="bg-whiteSmoke">
            <div className="flex px-10 py-5 text-white xl:px-32 bg-textColor">
                ...
                <div className="flex ml-auto">
                    <a href="https://www.facebook.com/trendpvc/" className="px-3"><RiFacebookFill size={25} /></a>
            ...
            <footer className="px-10 text-black md:pr-16 md:pb-10 xl:px-32">
                <div className="grid justify-center grid-cols-6 mt-10 mb-10 text-center md:mt-20 md:text-left">
                    <a className="col-span-6 text-center md:text-left md:col-span-2">
                        <Link href="/">
                    ...
                    <div className="col-span-6 mt-6 md:mt-0 md:col-span-1">
                        ...
                        <ul className="font-normal list-none">
                            <Link href="/"><li className="mt-2 cursor-pointer">Home</li></Link>
                            <Link href="/About"><li className="mt-2 cursor-pointer">About Us</li></Link>
                            <Link href="/Products"><li className="mt-2 cursor-pointer">Products</li></Link>
                            <Link href="/Catalogues"><li className="mt-2 cursor-pointer">Catalogues</li></Link>
                            <Link href="/Contact"><li className="mt-2 cursor-pointer">Contact Us</li></Link>
                        </ul>
                    </div>
